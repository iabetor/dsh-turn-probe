...
A "Lineage" tab in the conversation view that lets you:
...
Then restart the web instance (`dsh web`) and open any session — the "Lineage" tab appears next to Chat / Trajectory.

## Usage

1. Open a session and switch to the **Lineage** tab.
...
4. Toggle **Preview / Source** to view rendered markdown or raw text.
5. Click **Analyze** — the model analyzes that exact turn and returns the insight below.
